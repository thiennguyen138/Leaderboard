...
public class LeaderBoardServiceVertxEBProxy implements LeaderBoardService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public LeaderBoardServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public LeaderBoardServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public void getLeaderboardInRange(int from, int to, Handler<AsyncResult<List<String>>> result){
    ...
    _deliveryOptions.addHeader("action", "getLeaderboardInRange");
    _deliveryOptions.getHeaders().set("action", "getLeaderboardInRange");
  ...
  public void getRankByUserId(String userId, Handler<AsyncResult<Long>> result){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getRankByUserId");
    _deliveryOptions.getHeaders().set("action", "getRankByUserId");
  ...
  public void getRelativeLeaderboard(long fromRank, long toRank, Handler<AsyncResult<List<String>>> result){
    ...
    JsonObject _json = new JsonObject();
    _json.put("fromRank", fromRank);
    _json.put("toRank", toRank);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "getRelativeLeaderboard");
    _deliveryOptions.getHeaders().set("action", "getRelativeLeaderboard");
    _vertx.eventBus().<JsonArray>request(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        result.handle(Future.failedFuture(res.cause()));
      } else {
